...
export default class unmuteall implements IBotCommand {

    private readonly _command = "unmuteall";
    ...
    async runCommand(args: string[], messageObject: Discord.Message, client: Discord.Client): Promise<void> {
        ...
        for (let member of mentionedChanel.members) { member[1].setMute(false); }
